...
namespace condicionales_multiples
{
    class ejercicio_05
    {
        static void Maint(string[] args)
        {
            ...
            bool resp1 = double.TryParse(Console.ReadLine(), out number_rollers);
            Console.WriteLine("digite la cantidad de brochas de cerdas: ");
            bool resp2 = double.TryParse(Console.ReadLine(), out number_brushes);
            ...
            bool resp3 = double.TryParse(Console.ReadLine(), out payment);
